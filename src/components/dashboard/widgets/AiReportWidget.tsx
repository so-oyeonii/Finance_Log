    ...
    <div className="bg-white rounded-xl shadow-sm p-4 animate-fade-in">
      ...
      {isLoading && (
        <div className="text-center py-6">
          ...
          <p className="text-sm text-slate-500">AI가 분석 중입니다...</p>
        </div>
      )}
      ...
      {report && !isLoading && (
        <div className="space-y-3">
          <div className="bg-violet-50 rounded-lg p-3">
            <p className="text-sm font-bold text-violet-700 mb-1">{report.title}</p>
            <p className="text-xs text-slate-600 leading-relaxed">{report.message}</p>
          </div>
